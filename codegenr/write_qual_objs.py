...
def write_qual_obj_lines(params_dict):
    module_name = 'obj_vals_main'
    ...
    pyxcd.els()
    pyxcd.w(('from .cp_obj_ftns cimport obj_ftn_refresh'))
    pyxcd.els()
    ...
    # Functions
    #==========================================================================
    pyxcd.w('cpdef get_obj_val(dict args_dict):')
    pyxcd.ind()
    pyxcd.w('cdef:')
    pyxcd.ind()
    pyxcd.w('# ulongs')
    ...
    pyxcd.w('# doubles')
    pyxcd.w('DT_D curr_obj_val, lo_freq_pen_wt, min_freq')
    pyxcd.els()
    ...
    if obj_1_flag or obj_3_flag:
        ...
        pyxcd.w('n_time_steps = in_ppt_arr.shape[0]')
    ...
    if obj_2_flag or obj_5_flag:
        ...
        pyxcd.w('n_time_steps = in_cats_ppt_arr.shape[0]')
    ...
    if obj_4_flag or obj_6_flag or obj_7_flag:
        ...
        pyxcd.w('n_time_steps = in_wet_arr_calib.shape[0]')
    ...
    if obj_8_flag:
        ...
        pyxcd.w('n_time_steps = in_lorenz_arr.shape[0]')
    ...
    pyxcd.ind()
    pyxcd.w(r"print('\n')")
    pyxcd.w('print(\'Getting objective function value...\')')
