...
if __name__ == '__main__':
    ...
    out_net_cdf_file = main_dir / r'NCAR_ds010.0_19800101_20091231_dailydata_germany.nc'
...
#     snip_nc.set_coords(330, 45, 35, 65, 'geo', 'lon', 'lat')
    snip_nc.set_coords(2.0, 19, 40, 58, 'geo', 'lon', 'lat')
    snip_nc.set_times('1980-01-01', '2009-12-31', '%Y-%m-%d', [12, 13], 'H', 'time')
