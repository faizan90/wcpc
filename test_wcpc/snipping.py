...
#     in_net_cdf_file = main_dir / r'ncep_1948_2014_level_500.nc'
#     out_net_cdf_file = main_dir / r'ncep_1948_2014_level_500_europe.nc'
...
#     snip_nc.set_coords(320, 65, 20, 80, 'geo', 'lon', 'lat')
    snip_nc.set_times('1961-01-01', '2015-12-31', '%Y-%m-%d', [12, 13], 'H', 'time')
#     snip_nc.set_times('1995-01-01', '2014-12-31', '%Y-%m-%d', [0], 'H', 'time')
    snip_nc.snip()
    snip_nc.save_snip()
